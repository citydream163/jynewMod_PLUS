Talkplus(2065);--61, "怎样，想通了吗。"
if AskJoin() == true then goto label0 end;
Talkplus(2066);--0, "不行，我还是想当个大侠，不肖与你这个人为伍。"
Talkplus(2067);--61, "真是可惜，本来还想跟你研究研究“床上功夫”呢。"
do return end;
::label0::
Talkplus(2068);--0, "好吧，那我们就一起称霸武林吧。反正有句名言不是说“好人早死，坏人较长命”。"
if JudgeFemaleInTeam() == true then goto label1 end;
Talkplus(2069);--61, "不行，不行，我们同伴中没有女的我会受不了，等你找到女的再说。"
do return end;
::label1::
if TeamIsFull() == false then goto label2 end;
Talkplus(2070);--61, "你的队伍已满，我无法加入。"
do return end;
::label2::
Talkplus(2071);--61, "走吧，再去找一些邪恶的人来加入。"
DarkScence();
