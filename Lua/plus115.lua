Talkplus(582);--13,"少侠准备好要破我明教之“光明圣火阵”了吗？"
if AskBattle() == true then goto label0 end;
Talkplus(583);--0,"我还没准备好。"
do return end;
::label0::
Talkplus(584);--0,"我准备好了，还请各位前辈高抬贵手。"
...
AddHpWithoutHint(10, 200);
AddHpWithoutHint(11, 200);
AddHpWithoutHint(12, 200);
AddHpWithoutHint(13, 200);
AddHpWithoutHint(14, 200);
AddHpWithoutHint(15, 200);
end;
if TryBattle(15) == true then goto label1 end;
LightScence();
Talkplus(585);--13,"小兄弟似乎需要再磨练。"
do return end;
::label1::
...
LightScence();
Talkplus(586);--12,"果然是英雄出少年，我们这些老骨头都不行了。"
Talkplus(587);--14,"今后武林中，就是你们这些年轻人的天下了。"
Talkplus(588);--0,"是各位前辈承让了。"
Talkplus(589);--13,"就遵照我们的约定，《倚天屠龙记》一书该为少侠所有。"
Talkplus(590);--0,"谢谢各位前辈。在经过了这么多波折才拿到此书，虽说辛苦，但也从中学到不少东西。世上的好坏人真的很难去界定，名门正派的人，外表有羊皮披挂着，反倒是更容易去为恶。"
Talkplus(591);--10,"经过了这些，你的江湖历练又增长了不少。希望你在其它的旅途上也更能顺利。"
Talkplus(592);--0,"好了，我还要去忙别的了。有空我会再回来的。"
AddItem(155, 1);
AddRepute(10);
do return end;