Talkplus(2375);--0, "诸位大师，我想进少林寺参观一下，可以吗？"
Talkplus(2376);--96, "请施主先将兵刃留下，待下山前我们再归还予你。"
Talkplus(2377);--0, "对了，这是少林寺千年下来的传统，以表示对少林寺的尊重。好，我就将兵刃……＜等等，武侠小说中的主角向来都不吃这一套的，若我这么听话，那戏还有什么好看的……＞等会，这兵刃向来不与我离身，我不能将兵刃放下。"
Talkplus(2378);--96, "那就请施主下山。"
if AskBattle() == true then goto label0 end;
Talkplus(2379);--0, "好，好，我下回再来。"
...
do return end;
::label0::
Talkplus(2380);--0, "可是我还是想进去看看，对不住了。"
...
ModifyEvent(-2, 6, -2, -2, 522, -1, -1, -2, -2, -2, -2, -2, -2);--by fanyu|启动脚本-522。场景28-6
LightScence();
Talkplus(2381);--96, "请施主下山。"
Talkplus(2382);--0, "可是我还是想进去看看，对不住了。"
do return end;
::label1::
