...
Talkplus(1573);--41, "侠客岛赏善罚恶使者，前来拜见雪山派掌门！"
Talkplus(1574);--43, "尊驾二位便是侠客岛的赏善罚恶使者吗？"
Talkplus(1575);--42, "正是。不知哪位是雪山派掌门人？我们奉侠客岛岛主之命，手持铜牌前来，邀请贵派掌门赴敝岛相叙，喝碗腊八粥。"
ScenceFromTo(28, 17, 28, 24);
jyx2_CameraFollowPlayer();
Talkplus(1576);--0, "＜搞不好侠客岛上有线索？不是有本书与“侠”字有关联吗？＞"
WalkFromTo(28, 24, 28, 19);
jyx2_WalkFromTo(-1,2819);
Talkplus(1577);--0, "铜牌给我好不好？"
Talkplus(1578);--41, "恐怕不行，侠客岛所邀请的是各门派的掌门及对武学有特殊见解的武林高手。"
Talkplus(1579);--0, "那如果我打败他，是不是表示我比他有资格去？"
Talkplus(1580);--43, "哪里来的小娃儿，敢在我凌霄城撒野。"
if TryBattle(59) == true then goto label0 end;
Dead();
do return end;
::label0::
LightScence();
Talkplus(1581);--0, "前辈，承让了！"
Talkplus(1582);--43, "哼！白某无话可说，也无脸去喝这腊八粥。"
Talkplus(1583);--41, "好！这位兄弟，十二月初八，请到侠客岛喝碗腊八粥。"
DarkScence();
