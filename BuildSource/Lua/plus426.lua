...
Talkplus(1938);--0, "想不到这中间的恩怨是如此复杂。唉！又是“情”字。"
do return end;
::label1::
AddEthics(-1);
...
::label2::
LightScence();
Talkplus(1939);--65, "阁下还是回去请瑛姑亲自来动手吧，我会在这等她的。"
do return end;