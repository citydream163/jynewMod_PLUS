...
elseif radnum >= 95 and radnum < 101 then goto label10
	...
	Talkplus(4000);--0,"走远路，长见识。"
	AddWuchang(0,1);
end;
do return end;
::label0::
Talkplus(4001);--0,"走累了，休息一下。"
RestFight();
DarkScence();        
LightScence();
do return end;
...
Talkplus(4002);--0,"走远路需要做好防护。"
AddHeal(0,1);
do return end;
::label2::
	if JudgeDefence(0,1,30) == false then goto label18 end;
Talkplus(4003);--0,"探迷宫是我的爱好。"
AddDefence(0,1);
do return end;
::label3::
	if JudgeQuanzhang(0,1,30) == false then goto label14 end;
Talkplus(4004);--0,"嘿嘿哈嘿，边走路边打拳。"
AddQuanzhang(0,1);
do return end;
::label4::
	if JudgeYujian(0,1,30) == false then goto label15 end;
Talkplus(4005);--0,"御剑飞升。"
AddYujian(0,1);
do return end;
::label5::
Talkplus(4006);--0,"注意墙角的毒虫。"
AddAnqi(0,1);
do return end;
::label6::
if JudgeMoney(moneynum) == false then goto label11 end;
Talkplus(4007);--0,"哎呀不好，钱袋子漏了。"
AddItem(174, -moneynum);
do return end;
::label7::
Talkplus(4008);--0,"穿越迷宫，增长见闻。"
AddExp(0, moneynum);
do return end;
::label8::
	if JudgeAttackPoison(0,1,30) == false then goto label16 end;
Talkplus(4009);--0,"差一点就抓到那只莽牯朱蛤了。"
AddAttackPoison(0,1);
do return end;
::label9::
	if JudgeQimen(0,1,15) == false then goto label17 end;
Talkplus(4010);--0,"奇门遁甲用在这里最合适。"
AddQimen(0,1);
do return end;
::label10::
Talkplus(4011);--0,"出门见财。"
AddItem(174, moneynum);
do return end;
::label11::
Talkplus(4012);--0,"没事就是最好的事。"
do return end;
::label12::
Talkplus(4013);--0,"我真见多识广。"
do return end;
::label13::
Talkplus(4014);--0,"备用药品都准备好了。"
do return end;
::label14::
Talkplus(4015);--0,"拳拳到肉。"
do return end;
::label15::
Talkplus(4016);--0,"御剑开路。"
do return end;
::label16::
Talkplus(4017);--0,"小毒物已经伤不到我了。"
do return end;
::label17::
Talkplus(4018);--0,"也许可以学习一些其他的武功。"
do return end;
::label18::
Talkplus(4019);--0,"弯弯绕绕，曲曲折折。"
do return end;
::label19::
